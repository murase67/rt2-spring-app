...
public class SearchForEmployeesByEmpNameService {
	 ...
	 */
	//TODO ここに記述
	public List<EmployeeBean> execute(String seachString){
		List<Employee> seachEmpName = repository.findByEmpNameContainingOrderByEmpId(seachString);
		List<EmployeeBean> employeeBean = BeanManager.copyEntityListToBeanList(seachEmpName);
		return employeeBean;
	}
}